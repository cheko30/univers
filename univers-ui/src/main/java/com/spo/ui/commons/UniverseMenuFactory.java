package com.spo.ui.commons;

import org.springframework.security.core.context.SecurityContextHolder;

import com.spo.ui.navigatior.UniversNavigator;
import com.spo.utils.StringUtils;
...
public class UniverseMenuFactory implements UIComponentBuilder
{
	private class UniversMenu extends VerticalLayout implements Property.ValueChangeListener
	{
		...
		public UniversMenu layout()
		{
			...
			mainMenu.setParent(StringUtils.MENU_OPERATIONS.getString(), StringUtils.MENU_UNIVERSITIES.getString());
		...
		public void valueChange(ValueChangeEvent event)
		{
			...
			String path = selectedItemPath.toLowerCase().replaceFirst("\\s+", "");
