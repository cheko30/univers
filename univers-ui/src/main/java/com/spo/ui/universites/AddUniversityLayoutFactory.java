...
import com.spo.service.adduniversity.AddUnivesityService;
import com.spo.utils.NotifiactionMessages;
import com.spo.utils.StudentsStringUtils;
import com.spo.utils.UniversityStringUtils;
...
{
	@Autowired
	private AddUnivesityService addUniversityService;
	...
	private class AddUniversityLayout extends VerticalLayout implements Button.ClickListener
	{
		...
		public void buttonClick(ClickEvent event) 
		{
			...
			{
				Notification.show(NotifiactionMessages.UNIVERSITY_SAVED_VALIDATION_ERROR_TITLE.getString(),
						NotifiactionMessages.UNIVERSITY_SAVED_VALIDATION_ERROR_DESCRIPTION.getString(), Type.ERROR_MESSAGE);
			...
			Notification.show(NotifiactionMessages.UNIVERSITY_SAVE_SUCCESS_TITLE.getString(),
							NotifiactionMessages.UNIVERSITY_SAVE_SUCCESS_DESCRIPTION.getString(), Type.WARNING_MESSAGE);
